...
class Attendance:
    def __init__(self):  
        ...
        #----------database connection-----------#
        try:
            self.connection = mysql.connector.connect(host="localhost",password="",user="root",database="pythonproject")
        except:
    ...
    def signup(self):
        ...
        #----geometry-----#
        signup_interface.geometry('1500x1500')
    ...
    def login_sucess(self,username):
        ...
        #----geometry-------#
        login_sucess_interface.geometry('1500x1500')
